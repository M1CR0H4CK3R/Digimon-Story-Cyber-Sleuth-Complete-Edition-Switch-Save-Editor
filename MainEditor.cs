...
namespace DigimonStorySaveEditor
{
    public partial class MainMenu : Form
    {
        public MainMenu()
        {
            ...
            pictureBoxCSDigimonPartySlot2Portrait.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxCSDigimonPartySlot2Dot.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxCSDigimonPartySlot3Portrait.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxCSDigimonPartySlot3Dot.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxHMDigimonPartySlot1Portrait.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxHMDigimonPartySlot1Dot.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxHMDigimonPartySlot2Portrait.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxHMDigimonPartySlot2Dot.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxHMDigimonPartySlot3Portrait.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBoxHMDigimonPartySlot3Dot.SizeMode = PictureBoxSizeMode.StretchImage;
        }
        ...
        public static UInt32 hmOffset = 0x617A0;
        public void showFields()
        {
            foreach (TabControl tc in tabMain.TabPages)
            {
                foreach (TabControl tc2 in tc.TabPages)
                {
                    foreach (TabControl tc3 in tc2.TabPages)
                    {
                        foreach (TabPage tp in tc3.TabPages)
                        {
                            tp.Show();
                            foreach (Control ctrl in tc3.TabPages)
                            {
                                ctrl.Show();
                            }
                            foreach (TabControl tc4 in tc3.TabPages)
                            {
                                tc4.Show();
                                foreach (Control ctrl2 in tc4.TabPages)
                                {
                                    ctrl2.Show();
                                }
                            }
        ...
        private void openFileDlg()
        {
            ...
            {
                Filter = "DSCSCE Save Files (000*.bin)|000*.bin"
            };
        ...
        private void getData()
        {
            ...
            if (savegameBr.ReadByte() != 0)
            {
                ...
                numericUpDownCSDigimonPartySlot1MaxHP.Value = CSDigimonPartySlot1MaxHPDec * 10;
                //Bonus HP
                ...
                numericUpDownCSDigimonPartySlot1BonusSP.Value = CSDigimonPartySlot1BonusSPDec / 100;
                //Attack
                ...
                numericUpDownCSDigimonPartySlot1BonusAttack.Value = CSDigimonPartySlot1BonusAttackDec / 100;
                //Defense
                ...
                numericUpDownCSDigimonPartySlot1BonusDefense.Value = CSDigimonPartySlot1BonusDefenseDec / 100;
                //Intelligence
                ...
                numericUpDownCSDigimonPartySlot1BonusIntelligence.Value = CSDigimonPartySlot1BonusIntelligenceDec / 100;
                //Speed
                ...
                numericUpDownCSDigimonPartySlot1BonusSpeed.Value = CSDigimonPartySlot1BonusSpeedDec / 100;
                //CAM
            ...
            if (savegameBr.ReadByte() != 0)
            {
                ...
                numericUpDownCSDigimonPartySlot2MaxHP.Value = CSDigimonPartySlot2MaxHPDec * 10;
                //Bonus HP
                ...
                numericUpDownCSDigimonPartySlot2BonusSP.Value = CSDigimonPartySlot2BonusSPDec / 100;
                //Attack
                ...
                numericUpDownCSDigimonPartySlot2BonusAttack.Value = CSDigimonPartySlot2BonusAttackDec / 100;
                //Defense
                ...
                numericUpDownCSDigimonPartySlot2BonusDefense.Value = CSDigimonPartySlot2BonusDefenseDec / 100;
                //Intelligence
                ...
                numericUpDownCSDigimonPartySlot2BonusIntelligence.Value = CSDigimonPartySlot2BonusIntelligenceDec / 100;
                //Speed
                ...
                numericUpDownCSDigimonPartySlot2BonusSpeed.Value = CSDigimonPartySlot2BonusSpeedDec / 100;
                //CAM
            ...
            if (savegameBr.ReadByte() != 0)
            {
                ...
                numericUpDownCSDigimonPartySlot3MaxHP.Value = CSDigimonPartySlot3MaxHPDec * 10;
                //Bonus HP
                ...
                numericUpDownCSDigimonPartySlot3BonusSP.Value = CSDigimonPartySlot3BonusSPDec / 100;
                //Attack
                ...
                numericUpDownCSDigimonPartySlot3BonusAttack.Value = CSDigimonPartySlot3BonusAttackDec / 100;
                //Defense
                ...
                numericUpDownCSDigimonPartySlot3BonusDefense.Value = CSDigimonPartySlot3BonusDefenseDec / 100;
                //Intelligence
                ...
                numericUpDownCSDigimonPartySlot3BonusIntelligence.Value = CSDigimonPartySlot3BonusIntelligenceDec / 100;
                //Speed
                ...
                numericUpDownCSDigimonPartySlot3BonusSpeed.Value = CSDigimonPartySlot3BonusSpeedDec / 100;
                //CAM
            ...
            #endregion
            //TODO: Read in DigiFarm data in Cyber Sleuth data
            #region DigiFarmData
            //TODO: Read in DigiFarm Island 1 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland1Data
            #endregion
            //TODO: Read in DigiFarm Island 2 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland2Data
            #endregion
            //TODO: Read in DigiFarm Island 3 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland3Data
            #endregion
            //TODO: Read in DigiFarm Island 4 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland4Data
            #endregion
            //TODO: Read in DigiFarm Island 5 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland5Data
            #endregion
            #endregion
            //Read in Cyber Sleuth character data
            #region CharacterData
            #region CharacterStats
            //Read in character name from Cyber Sleuth character data
            savegameBr.BaseStream.Position = 0x4B984;
            byte[] CSCharacterStatsCharacterName = savegameBr.ReadBytes(7);
            string CSCharacterStatsCharacterNameDec = Encoding.ASCII.GetString(CSCharacterStatsCharacterName);
            textBoxCSCharacterStatsCharacterName.Text = CSCharacterStatsCharacterNameDec;
            //Read in character gender from Cyber Sleuth character data
            savegameBr.BaseStream.Position = 0x4B980;
            byte CSCharacterStatsCharacterGender = savegameBr.ReadByte();
            comboBoxCSCharacterStatsCharacterGender.Text = convertGenderIDtoString(CSCharacterStatsCharacterGender);
            //Read in money from Cyber Sleuth character data
            savegameBr.BaseStream.Position = 0x4B9B8;
            byte[] CSCharacterStatsMoney = savegameBr.ReadBytes(4);
            UInt32 CSCharacterStatsMoneyDec = BitConverter.ToUInt32(CSCharacterStatsMoney, 0);
            numericUpDownCSCharacterStatsMoney.Value = CSCharacterStatsMoneyDec;
            //Read in rank from Cyber Sleuth character data
            savegameBr.BaseStream.Position = 0x4B9C0;
            byte CSCharacterStatsCharacterRank = savegameBr.ReadByte();
            numericUpDownCSCharacterStatsCharacterRank.Value = CSCharacterStatsCharacterRank;
            //Read in CSP from Cyber Sleuth character data
            savegameBr.BaseStream.Position = 0x4B9BC;
            byte[] CSCharacterStatsCSP = savegameBr.ReadBytes(4);
            UInt32 CSCharacterStatsCSPDec = BitConverter.ToUInt32(CSCharacterStatsCSP, 0);
            numericUpDownCSCharacterStatsCSP.Value = CSCharacterStatsCSPDec;
            #endregion
            //TODO: Read in inventory data in Cyber Sleuth character data
            #region InventoryData
            #endregion
            #endregion
            //Read in first Digimon in Hacker's Memory party data
            #region HMDigimonPartySlot1
            #region HMMain1
            //Check to see if it exists
            savegameBr.BaseStream.Position = (0x3CA9C + hmOffset);
            if (savegameBr.ReadByte() != 0)
            {
                //ID
                savegameBr.BaseStream.Position = (0x3CAAC + hmOffset);
                ...
                //Nickname
                savegameBr.BaseStream.Position = (0x3CABC + hmOffset);
                ...
                //Digivolution
                savegameBr.BaseStream.Position = (0x3CAB8 + hmOffset);
                ...
                //Type
                savegameBr.BaseStream.Position = (0x3CAB4 + hmOffset);
                ...
                //Attribute
                savegameBr.BaseStream.Position = (0x3CAB0 + hmOffset);
                ...
                //Personality
                savegameBr.BaseStream.Position = (0x3CB20 + hmOffset);
                ...
                //Support Skills
                savegameBr.BaseStream.Position = (0x3CCC0 + hmOffset);
                ...
                #region HMStats1
                //Equip Slots
                savegameBr.BaseStream.Position = (0x3CCC4 + hmOffset);
                ...
                //Current Level
                savegameBr.BaseStream.Position = (0x3CB10 + hmOffset);
                ...
                //Current HP
                savegameBr.BaseStream.Position = (0x3CB24 + hmOffset);
                ...
                //Max HP
                savegameBr.BaseStream.Position = (0x3CB28 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot1MaxHP.Value = HMDigimonPartySlot1MaxHPDec * 10;
                //Bonus HP
                savegameBr.BaseStream.Position = (0x3CB2C + hmOffset);
                ...
                //Current SP
                savegameBr.BaseStream.Position = (0x3CB30 + hmOffset);
                ...
                //Max SP
                savegameBr.BaseStream.Position = (0x3CB34 + hmOffset);
                ...
                //Bonus SP
                savegameBr.BaseStream.Position = (0x3CB38 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot1BonusSP.Value = HMDigimonPartySlot1BonusSPDec / 100;
                //Attack
                savegameBr.BaseStream.Position = (0x3CB3A + hmOffset);
                ...
                //Bonus Attack
                savegameBr.BaseStream.Position = (0x3CB3C + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot1BonusAttack.Value = HMDigimonPartySlot1BonusAttackDec / 100;
                //Defense
                savegameBr.BaseStream.Position = (0x3CB3E + hmOffset);
                ...
                //Bonus Defense
                savegameBr.BaseStream.Position = (0x3CB40 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot1BonusDefense.Value = HMDigimonPartySlot1BonusDefenseDec / 100;
                //Intelligence
                savegameBr.BaseStream.Position = (0x3CB42 + hmOffset);
                ...
                //Bonus Intelligence
                savegameBr.BaseStream.Position = (0x3CB44 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot1BonusIntelligence.Value = HMDigimonPartySlot1BonusIntelligenceDec / 100;
                //Speed
                savegameBr.BaseStream.Position = (0x3CB46 + hmOffset);
                ...
                //Bonus Speed
                savegameBr.BaseStream.Position = (0x3CB48 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot1BonusSpeed.Value = HMDigimonPartySlot1BonusSpeedDec / 100;
                //CAM
                savegameBr.BaseStream.Position = (0x3CB4C + hmOffset);
                ...
                //ABI
                savegameBr.BaseStream.Position = (0x3CB4A + hmOffset);
                ...
                #region HMEquipment1
                //Equip 1
                savegameBr.BaseStream.Position = (0x3CCC6 + hmOffset);
                ...
                //Equip 2
                savegameBr.BaseStream.Position = (0x3CCC8 + hmOffset);
                ...
                //Equip 3
                savegameBr.BaseStream.Position = (0x3CCCA + hmOffset);
                ...
                //Accessory
                savegameBr.BaseStream.Position = (0x3CCCC + hmOffset);
                ...
                #endregion
                #region HMCurrentSkills1
                //Current Skill 1
                savegameBr.BaseStream.Position = (0x3CB50 + hmOffset);
                ...
                //Learned Skill 1
                savegameBr.BaseStream.Position = (0x3CB80 + hmOffset);
            ...
            #endregion
            //Read in second Digimon in Hacker's Memory party data
            #region HMDigimonPartySlot2
            #region HMMain2
            //Check to see if it exists
            savegameBr.BaseStream.Position = (0x3CCDC + hmOffset);
            if (savegameBr.ReadByte() != 0)
            {
                //ID
                savegameBr.BaseStream.Position = (0x3CCEC + hmOffset);
                ...
                //Nickname
                savegameBr.BaseStream.Position = (0x3CCFC + hmOffset);
                ...
                //Digivolution
                savegameBr.BaseStream.Position = (0x3CCF8 + hmOffset);
                ...
                //Type
                savegameBr.BaseStream.Position = (0x3CCF4 + hmOffset);
                ...
                //Attribute
                savegameBr.BaseStream.Position = (0x3CCF0 + hmOffset);
                ...
                //Personality
                savegameBr.BaseStream.Position = (0x3CD60 + hmOffset);
                ...
                //Support Skills
                savegameBr.BaseStream.Position = (0x3CF00 + hmOffset);
                ...
                #region HMStats2
                //Equip Slots
                savegameBr.BaseStream.Position = (0x3CF04 + hmOffset);
                ...
                //Current Level
                savegameBr.BaseStream.Position = (0x3CD50 + hmOffset);
                ...
                //Current HP
                savegameBr.BaseStream.Position = (0x3CD64 + hmOffset);
                ...
                //Max HP
                savegameBr.BaseStream.Position = (0x3CD68 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot2MaxHP.Value = HMDigimonPartySlot2MaxHPDec * 10;
                //Bonus HP
                savegameBr.BaseStream.Position = (0x3CD6C + hmOffset);
                ...
                //Current SP
                savegameBr.BaseStream.Position = (0x3CD70 + hmOffset);
                ...
                //Max SP
                savegameBr.BaseStream.Position = (0x3CD74 + hmOffset);
                ...
                //Bonus SP
                savegameBr.BaseStream.Position = (0x3CD78 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot2BonusSP.Value = HMDigimonPartySlot2BonusSPDec / 100;
                //Attack
                savegameBr.BaseStream.Position = (0x3CD7A + hmOffset);
                ...
                //Bonus Attack
                savegameBr.BaseStream.Position = (0x3CD7C + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot2BonusAttack.Value = HMDigimonPartySlot2BonusAttackDec / 100;
                //Defense
                savegameBr.BaseStream.Position = (0x3CD7E + hmOffset);
                ...
                //Bonus Defense
                savegameBr.BaseStream.Position = (0x3CD80 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot2BonusDefense.Value = HMDigimonPartySlot2BonusDefenseDec / 100;
                //Intelligence
                savegameBr.BaseStream.Position = (0x3CD82 + hmOffset);
                ...
                //Bonus Intelligence
                savegameBr.BaseStream.Position = (0x3CD84 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot2BonusIntelligence.Value = HMDigimonPartySlot2BonusIntelligenceDec / 100;
                //Speed
                savegameBr.BaseStream.Position = (0x3CD86 + hmOffset);
                ...
                //Bonus Speed
                savegameBr.BaseStream.Position = (0x3CD88 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot2BonusSpeed.Value = HMDigimonPartySlot2BonusSpeedDec / 100;
                //CAM
                savegameBr.BaseStream.Position = (0x3CD8C + hmOffset);
                ...
                //ABI
                savegameBr.BaseStream.Position = (0x3CD8A + hmOffset);
                ...
                #region HMEquipment2
                //Equip 1
                savegameBr.BaseStream.Position = (0x3CF06 + hmOffset);
                ...
                //Equip 2
                savegameBr.BaseStream.Position = (0x3CF08 + hmOffset);
                ...
                //Equip 3
                savegameBr.BaseStream.Position = (0x3CF0A + hmOffset);
                ...
                //Accessory
                savegameBr.BaseStream.Position = (0x3CF0C + hmOffset);
                ...
                #endregion
                #region HMCurrentSkills2
                //Current Skill 1
                savegameBr.BaseStream.Position = (0x3CD90 + hmOffset);
                ...
                //Learned Skill 1
                savegameBr.BaseStream.Position = (0x3CDC0 + hmOffset);
            ...
            #endregion
            //Read in third Digimon in Hacker's Memory party data
            #region HMDigimonPartySlot3
            #region HMMain3
            //Check to see if it exists
            savegameBr.BaseStream.Position = (0x3CF1C + hmOffset);
            if (savegameBr.ReadByte() != 0)
            {
                //ID
                savegameBr.BaseStream.Position = (0x3CF2C + hmOffset);
                ...
                //Nickname
                savegameBr.BaseStream.Position = (0x3CF3C + hmOffset);
                ...
                //Digivolution
                savegameBr.BaseStream.Position = (0x3CF38 + hmOffset);
                ...
                //Type
                savegameBr.BaseStream.Position = (0x3CF34 + hmOffset);
                ...
                //Attribute
                savegameBr.BaseStream.Position = (0x3CF30 + hmOffset);
                ...
                //Personality
                savegameBr.BaseStream.Position = (0x3CFA0 + hmOffset);
                ...
                //Support Skills
                savegameBr.BaseStream.Position = (0x3D140 + hmOffset);
                ...
                #region HMStats3
                //Equip Slots
                savegameBr.BaseStream.Position = (0x3D144 + hmOffset);
                ...
                //Current Level
                savegameBr.BaseStream.Position = (0x3CF90 + hmOffset);
                ...
                //Current HP
                savegameBr.BaseStream.Position = (0x3CFA4 + hmOffset);
                ...
                //Max HP
                savegameBr.BaseStream.Position = (0x3CFA8 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot3MaxHP.Value = HMDigimonPartySlot3MaxHPDec * 10;
                //Bonus HP
                savegameBr.BaseStream.Position = (0x3CFAC + hmOffset);
                ...
                //Current SP
                savegameBr.BaseStream.Position = (0x3CFB0 + hmOffset);
                ...
                //Max SP
                savegameBr.BaseStream.Position = (0x3CFB4 + hmOffset);
                ...
                //Bonus SP
                savegameBr.BaseStream.Position = (0x3CFB8 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot3BonusSP.Value = HMDigimonPartySlot3BonusSPDec / 100;
                //Attack
                savegameBr.BaseStream.Position = (0x3CFBA + hmOffset);
                ...
                //Bonus Attack
                savegameBr.BaseStream.Position = (0x3CFBC + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot3BonusAttack.Value = HMDigimonPartySlot3BonusAttackDec / 100;
                //Defense
                savegameBr.BaseStream.Position = (0x3CFBE + hmOffset);
                ...
                //Bonus Defense
                savegameBr.BaseStream.Position = (0x3CFC0 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot3BonusDefense.Value = HMDigimonPartySlot3BonusDefenseDec / 100;
                //Intelligence
                savegameBr.BaseStream.Position = (0x3CFC2 + hmOffset);
                ...
                //Bonus Intelligence
                savegameBr.BaseStream.Position = (0x3CFC4 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot3BonusIntelligence.Value = HMDigimonPartySlot3BonusIntelligenceDec / 100;
                //Speed
                savegameBr.BaseStream.Position = (0x3CFC6 + hmOffset);
                ...
                //Bonus Speed
                savegameBr.BaseStream.Position = (0x3CFC8 + hmOffset);
                ...
                numericUpDownHMDigimonPartySlot3BonusSpeed.Value = HMDigimonPartySlot3BonusSpeedDec / 100;
                //CAM
                savegameBr.BaseStream.Position = (0x3CFCC + hmOffset);
                ...
                //ABI
                savegameBr.BaseStream.Position = (0x3CFCA + hmOffset);
                ...
                #region HMEquipment3
                //Equip 1
                savegameBr.BaseStream.Position = (0x3D146 + hmOffset);
                ...
                //Equip 2
                savegameBr.BaseStream.Position = (0x3D148 + hmOffset);
                ...
                //Equip 3
                savegameBr.BaseStream.Position = (0x3D14A + hmOffset);
                ...
                //Accessory
                savegameBr.BaseStream.Position = (0x3D14C + hmOffset);
                ...
                #endregion
                #region HMCurrentSkills3
                //Current Skill 1
                savegameBr.BaseStream.Position = (0x3CFD0 + hmOffset);
                ...
                //Learned Skill 1
                savegameBr.BaseStream.Position = (0x3D000 + hmOffset);
            ...
            #endregion
            //Read in DigiFarm Data in 
            #region HMDigiFarmData
            //TODO: Read in DigiFarm Island 1 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland1Data
            #endregion
            //TODO: Read in DigiFarm Island 2 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland2Data
            #endregion
            //TODO: Read in DigiFarm Island 3 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland3Data
            #endregion
            //TODO: Read in DigiFarm Island 4 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland4Data
            #endregion
            //TODO: Read in DigiFarm Island 5 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland5Data
            #endregion
            #endregion
            //Read in Hacker's Memory character data
            #region HMCharacterData
            #region CharacterStats
            //Read in character name from Hacker's Memory character data
            savegameBr.BaseStream.Position = (0x4B984 + hmOffset);
            byte[] HMCharacterStatsCharacterName = savegameBr.ReadBytes(8);
            string HMCharacterStatsCharacterNameDec = Encoding.ASCII.GetString(HMCharacterStatsCharacterName);
            textBoxHMCharacterStatsCharacterName.Text = HMCharacterStatsCharacterNameDec;
            //Read in money from Hacker's Memory character data
            savegameBr.BaseStream.Position = (0x4B9B8 + hmOffset);
            byte[] HMCharacterStatsMoney = savegameBr.ReadBytes(4);
            UInt32 HMCharacterStatsMoneyDec = BitConverter.ToUInt32(HMCharacterStatsMoney, 0);
            numericUpDownHMCharacterStatsMoney.Value = HMCharacterStatsMoneyDec;
            //Read in rank from Hacker's Memory character data
            savegameBr.BaseStream.Position = (0x4B9C0 + hmOffset);
            byte HMCharacterStatsCharacterRank = savegameBr.ReadByte();
            numericUpDownHMCharacterStatsCharacterRank.Value = HMCharacterStatsCharacterRank;
            //Read in Hacker Points from Hacker's Memory character data
            savegameBr.BaseStream.Position = (0x4B9BC + hmOffset);
            byte[] HMCharacterStatsHackerPoints = savegameBr.ReadBytes(4);
            UInt32 HMCharacterStatsHackerPointsDec = BitConverter.ToUInt32(HMCharacterStatsHackerPoints, 0);
            numericUpDownHMCharacterStatsHackerPoints.Value = HMCharacterStatsHackerPointsDec;
            #endregion
            //TODO: Read in inventory data in Hacker's Memory character data
            #region HMInventoryData
            #endregion
            #endregion
            savegameBr.Close();
            savegameBr.Dispose();
        ...
        private void setData()
        {
            ...
            //Bonus HP
            byte[] CSDigimonPartySlot1BonusHPSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot1BonusHP.Value * 100);
            ...
            //Bonus SP
            byte[] CSDigimonPartySlot1BonusSPSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot1BonusSP.Value * 100);
            ...
            //Bonus Attack
            byte[] CSDigimonPartySlot1BonusAttackSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot1BonusAttack.Value * 100);
            ...
            //Bonus Defense
            byte[] CSDigimonPartySlot1BonusDefenseSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot1BonusDefense.Value * 100);
            ...
            //Bonus Intelligence
            byte[] CSDigimonPartySlot1BonusIntelligenceSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot1BonusIntelligence.Value * 100);
            ...
            //Bonus Speed
            byte[] CSDigimonPartySlot1BonusSpeedSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot1BonusSpeed.Value * 100);
            ...
            //Bonus HP
            byte[] CSDigimonPartySlot2BonusHPSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot2BonusHP.Value * 100);
            ...
            //Bonus SP
            byte[] CSDigimonPartySlot2BonusSPSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot2BonusSP.Value * 100);
            ...
            //Bonus Attack
            byte[] CSDigimonPartySlot2BonusAttackSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot2BonusAttack.Value * 100);
            ...
            //Bonus Defense
            byte[] CSDigimonPartySlot2BonusDefenseSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot2BonusDefense.Value * 100);
            ...
            //Bonus Intelligence
            byte[] CSDigimonPartySlot2BonusIntelligenceSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot2BonusIntelligence.Value * 100);
            ...
            //Bonus Speed
            byte[] CSDigimonPartySlot2BonusSpeedSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot2BonusSpeed.Value * 100);
            ...
            //Bonus HP
            byte[] CSDigimonPartySlot3BonusHPSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot3BonusHP.Value * 100);
            ...
            //Bonus SP
            byte[] CSDigimonPartySlot3BonusSPSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot3BonusSP.Value * 100);
            ...
            //Bonus Attack
            byte[] CSDigimonPartySlot3BonusAttackSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot3BonusAttack.Value * 100);
            ...
            //Bonus Defense
            byte[] CSDigimonPartySlot3BonusDefenseSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot3BonusDefense.Value * 100);
            ...
            //Bonus Intelligence
            byte[] CSDigimonPartySlot3BonusIntelligenceSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot3BonusIntelligence.Value * 100);
            ...
            //Bonus Speed
            byte[] CSDigimonPartySlot3BonusSpeedSet = BitConverter.GetBytes((short)numericUpDownCSDigimonPartySlot3BonusSpeed.Value * 100);
            ...
            #endregion
            #endregion
            //TODO: Save DigiFarm data in Cyber Sleuth data
            #region DigiFarmData
            //TODO: Save DigiFarm Island 1 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland1Data
            #endregion
            //TODO: Save DigiFarm Island 2 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland2Data
            #endregion
            //TODO: Save DigiFarm Island 3 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland3Data
            #endregion
            //TODO: Save DigiFarm Island 4 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland4Data
            #endregion
            //TODO: Save DigiFarm Island 5 data in Cyber Sleuth DigiFarm data
            #region DigiFarmIsland5Data
            #endregion
            #endregion
            //Save Cyber Sleuth character data
            #region CharacterData
            //Save Cyber Sleuth character stats
            #region CharacterStats
            //Save character name in Cyber Sleuth character data
            byte[] CSCharacterStatsCharacterNameSet = Encoding.ASCII.GetBytes(textBoxCSCharacterStatsCharacterName.Text);
            saveOpen.Position = 0x4B984;
            saveWrite.Write(CSCharacterStatsCharacterNameSet);
            if (CSCharacterStatsCharacterNameSet.Length < 7)
            {
                int bytesToAdd = 7 - CSCharacterStatsCharacterNameSet.Length;
                byte[] extra1 = new byte[bytesToAdd];
                saveWrite.Write(extra1);
            }
            ...
            byte[] CSCharacterDataMoneySet = BitConverter.GetBytes((UInt32)numericUpDownCSCharacterStatsMoney.Value);
            saveOpen.Position = 0x4B9B8;
            saveWrite.Write(CSCharacterDataMoneySet);
            //Save rank in Cyber Sleuth character data
            byte CSCharacterStatsCharacterRankSet = (byte)numericUpDownCSCharacterStatsCharacterRank.Value;
            saveOpen.Position = 0x4B9C0;
            saveWrite.Write(CSCharacterStatsCharacterRankSet);
            //Save CSP in Cyber Sleuth character data
            byte[] CSCharacterStatsCSPSet = BitConverter.GetBytes((UInt32)numericUpDownCSCharacterStatsCSP.Value);
            saveOpen.Position = 0x4B9BC;
            saveWrite.Write(CSCharacterStatsCSPSet);
            #endregion
            //TODO: Save inventory data in Cyber Sleuth character data
            #region InventoryData
            #endregion
            #endregion
            //Save first Digimon in Hacker's Memory party data
            #region DigimonPartySlot1
            #region HMMain1
            //ID
            byte[] HMDigimonPartySlot1IDSet = BitConverter.GetBytes(convertStringtoDigimonID(comboBoxHMDigimonPartySlot1ID.Text));
            saveOpen.Position = (0x3CAAC + hmOffset);
            ...
            saveOpen.Position = (0x3CAB8 + hmOffset);
            ...
            saveOpen.Position = (0x3CAB4 + hmOffset);
            ...
            saveOpen.Position = (0x3CAB0 + hmOffset);
            ...
            saveOpen.Position = (0x3CB20 + hmOffset);
            ...
            saveOpen.Position = (0x3CCC0 + hmOffset);
            ...
            saveOpen.Position = (0x3CCC4 + hmOffset);
            ...
            saveOpen.Position = (0x3CB04 + hmOffset);
            ...
            saveOpen.Position = (0x3CB18 + hmOffset);
            ...
            saveOpen.Position = (0x3CB10 + hmOffset);
            ...
            saveOpen.Position = (0x3CB12 + hmOffset);
            ...
            saveOpen.Position = (0x3CB14 + hmOffset);
            ...
            saveOpen.Position = (0x3CB24 + hmOffset);
            ...
            saveOpen.Position = (0x3CB28 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot1MaxHPSet);
            //Bonus HP
            byte[] HMDigimonPartySlot1BonusHPSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot1BonusHP.Value * 100);
            saveOpen.Position = (0x3CB2C + hmOffset);
            ...
            saveOpen.Position = (0x3CB30 + hmOffset);
            ...
            saveOpen.Position = (0x3CB34 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot1MaxSPSet);
            //Bonus SP
            byte[] HMDigimonPartySlot1BonusSPSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot1BonusSP.Value * 100);
            saveOpen.Position = (0x3CB38 + hmOffset);
            ...
            saveOpen.Position = (0x3CB3A + hmOffset);
            saveWrite.Write(HMDigimonPartySlot1AttackSet);
            //Bonus Attack
            byte[] HMDigimonPartySlot1BonusAttackSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot1BonusAttack.Value * 100);
            saveOpen.Position = (0x3CB3C + hmOffset);
            ...
            saveOpen.Position = (0x3CB3E + hmOffset);
            saveWrite.Write(HMDigimonPartySlot1DefenseSet);
            //Bonus Defense
            byte[] HMDigimonPartySlot1BonusDefenseSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot1BonusDefense.Value * 100);
            saveOpen.Position = (0x3CB40 + hmOffset);
            ...
            saveOpen.Position = (0x3CB42 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot1IntelligenceSet);
            //Bonus Intelligence
            byte[] HMDigimonPartySlot1BonusIntelligenceSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot1BonusIntelligence.Value * 100);
            saveOpen.Position = (0x3CB44 + hmOffset);
            ...
            saveOpen.Position = (0x3CB46 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot1SpeedSet);
            //Bonus Speed
            byte[] HMDigimonPartySlot1BonusSpeedSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot1BonusSpeed.Value * 100);
            saveOpen.Position = (0x3CB48 + hmOffset);
            ...
            saveOpen.Position = (0x3CB4C + hmOffset);
            ...
            saveOpen.Position = (0x3CB4A + hmOffset);
            ...
            saveOpen.Position = (0x3CCC6 + hmOffset);
            ...
            saveOpen.Position = (0x3CCC8 + hmOffset);
            ...
            saveOpen.Position = (0x3CCCA + hmOffset);
            ...
            //Learned Skill 15
            saveOpen.Position = (0x3CBF0 + hmOffset);
            ...
            if (checkBoxHMDigimonPartySlot1LearnedSkill17None.Checked || comboBoxHMDigimonPartySlot1LearnedSkill17.Text == "(None)")
            {
                ...
                byte[] zero = BitConverter.GetBytes(0);
                saveWrite.Write(empty);
                saveOpen.Position = (0x3CBF4 + hmOffset);
                saveWrite.Write(zero);
            }
            else
            {
            ...
            saveOpen.Position = (0x3CCF8 + hmOffset);
            ...
            saveOpen.Position = (0x3CCF4 + hmOffset);
            ...
            saveOpen.Position = (0x3CCF0 + hmOffset);
            ...
            saveOpen.Position = (0x3CD60 + hmOffset);
            ...
            saveOpen.Position = (0x3CF00 + hmOffset);
            ...
            saveOpen.Position = (0x3CF04 + hmOffset);
            ...
            saveOpen.Position = (0x3CD44 + hmOffset);
            ...
            saveOpen.Position = (0x3CD58 + hmOffset);
            ...
            saveOpen.Position = (0x3CD50 + hmOffset);
            ...
            saveOpen.Position = (0x3CD52 + hmOffset);
            ...
            saveOpen.Position = (0x3CD54 + hmOffset);
            ...
            saveOpen.Position = (0x3CD64 + hmOffset);
            ...
            saveOpen.Position = (0x3CD68 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot2MaxHPSet);
            //Bonus HP
            byte[] HMDigimonPartySlot2BonusHPSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot2BonusHP.Value * 100);
            saveOpen.Position = (0x3CD6C + hmOffset);
            ...
            saveOpen.Position = (0x3CD70 + hmOffset);
            ...
            saveOpen.Position = (0x3CD74 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot2MaxSPSet);
            //Bonus SP
            byte[] HMDigimonPartySlot2BonusSPSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot2BonusSP.Value * 100);
            saveOpen.Position = (0x3CD78 + hmOffset);
            ...
            saveOpen.Position = (0x3CD7A + hmOffset);
            saveWrite.Write(HMDigimonPartySlot2AttackSet);
            //Bonus Attack
            byte[] HMDigimonPartySlot2BonusAttackSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot2BonusAttack.Value * 100);
            saveOpen.Position = (0x3CD7C + hmOffset);
            ...
            saveOpen.Position = (0x3CD7E + hmOffset);
            saveWrite.Write(HMDigimonPartySlot2DefenseSet);
            //Bonus Defense
            byte[] HMDigimonPartySlot2BonusDefenseSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot2BonusDefense.Value * 100);
            saveOpen.Position = (0x3CD80 + hmOffset);
            ...
            saveOpen.Position = (0x3CD82 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot2IntelligenceSet);
            //Bonus Intelligence
            byte[] HMDigimonPartySlot2BonusIntelligenceSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot2BonusIntelligence.Value * 100);
            saveOpen.Position = (0x3CD84 + hmOffset);
            ...
            saveOpen.Position = (0x3CD86 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot2SpeedSet);
            //Bonus Speed
            byte[] HMDigimonPartySlot2BonusSpeedSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot2BonusSpeed.Value * 100);
            saveOpen.Position = (0x3CD88 + hmOffset);
            ...
            saveOpen.Position = (0x3CD8C + hmOffset);
            ...
            saveOpen.Position = (0x3CD8A + hmOffset);
            ...
            saveOpen.Position = (0x3CF06 + hmOffset);
            ...
            saveOpen.Position = (0x3CF08 + hmOffset);
            ...
            saveOpen.Position = (0x3CF0A + hmOffset);
            ...
            saveOpen.Position = (0x3CF38 + hmOffset);
            ...
            saveOpen.Position = (0x3CF34 + hmOffset);
            ...
            saveOpen.Position = (0x3CF30 + hmOffset);
            ...
            saveOpen.Position = (0x3CFA0 + hmOffset);
            ...
            saveOpen.Position = (0x3D140 + hmOffset);
            ...
            saveOpen.Position = (0x3D144 + hmOffset);
            ...
            saveOpen.Position = (0x3CF84 + hmOffset);
            ...
            saveOpen.Position = (0x3CF98 + hmOffset);
            ...
            saveOpen.Position = (0x3CF90 + hmOffset);
            ...
            saveOpen.Position = (0x3CF92 + hmOffset);
            ...
            saveOpen.Position = (0x3CF94 + hmOffset);
            ...
            saveOpen.Position = (0x3CFA4 + hmOffset);
            ...
            saveOpen.Position = (0x3CFA8 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot3MaxHPSet);
            //Bonus HP
            byte[] HMDigimonPartySlot3BonusHPSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot3BonusHP.Value * 100);
            saveOpen.Position = (0x3CFAC + hmOffset);
            ...
            saveOpen.Position = (0x3CFB0 + hmOffset);
            ...
            saveOpen.Position = (0x3CFB4 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot3MaxSPSet);
            //Bonus SP
            byte[] HMDigimonPartySlot3BonusSPSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot3BonusSP.Value * 100);
            saveOpen.Position = (0x3CFB8 + hmOffset);
            ...
            saveOpen.Position = (0x3CFBA + hmOffset);
            saveWrite.Write(HMDigimonPartySlot3AttackSet);
            //Bonus Attack
            byte[] HMDigimonPartySlot3BonusAttackSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot3BonusAttack.Value * 100);
            saveOpen.Position = (0x3CFBC + hmOffset);
            ...
            saveOpen.Position = (0x3CFBE + hmOffset);
            saveWrite.Write(HMDigimonPartySlot3DefenseSet);
            //Bonus Defense
            byte[] HMDigimonPartySlot3BonusDefenseSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot3BonusDefense.Value * 100);
            saveOpen.Position = (0x3CFC0 + hmOffset);
            ...
            saveOpen.Position = (0x3CFC2 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot3IntelligenceSet);
            //Bonus Intelligence
            byte[] HMDigimonPartySlot3BonusIntelligenceSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot3BonusIntelligence.Value * 100);
            saveOpen.Position = (0x3CFC4 + hmOffset);
            ...
            saveOpen.Position = (0x3CFC6 + hmOffset);
            saveWrite.Write(HMDigimonPartySlot3SpeedSet);
            //Bonus Speed
            byte[] HMDigimonPartySlot3BonusSpeedSet = BitConverter.GetBytes((short)numericUpDownHMDigimonPartySlot3BonusSpeed.Value * 100);
            saveOpen.Position = (0x3CFC8 + hmOffset);
            ...
            saveOpen.Position = (0x3CFCC + hmOffset);
            ...
            saveOpen.Position = (0x3CFCA + hmOffset);
            ...
            saveOpen.Position = (0x3D146 + hmOffset);
            ...
            saveOpen.Position = (0x3D148 + hmOffset);
            ...
            saveOpen.Position = (0x3D14A + hmOffset);
            ...
            #endregion
            #endregion
            //TODO: Save DigiFarm data in Hacker's Memory data
            #region HMDigiFarmData
            //TODO: Save DigiFarm Island 1 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland1Data
            #endregion
            //TODO: Save DigiFarm Island 2 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland2Data
            #endregion
            //TODO: Save DigiFarm Island 3 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland3Data
            #endregion
            //TODO: Save DigiFarm Island 4 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland4Data
            #endregion
            //TODO: Save DigiFarm Island 5 data in Hacker's Memory DigiFarm data
            #region HMDigiFarmIsland5Data
            #endregion
            #endregion
            //Save Hacker's Memory character data
            #region HMCharacterData
            //Save Hacker's Memory character stats
            #region HMCharacterStats
            //Save character name in Hacker's Memory character data
            ...
            //Save money in Hacker's Memory character data
            byte[] HMCharacterDataMoneySet = BitConverter.GetBytes((UInt32)numericUpDownHMCharacterStatsMoney.Value);
            saveOpen.Position = (0x4B9B8 + hmOffset);
            saveWrite.Write(HMCharacterDataMoneySet);
            //Save rank in Hacker's Memory character data
            byte HMCharacterStatsCharacterRankSet = (byte)numericUpDownHMCharacterStatsCharacterRank.Value;
            saveOpen.Position = (0x4B9C0 + hmOffset);
            saveWrite.Write(HMCharacterStatsCharacterRankSet);
            //Save Hacker Points in Hacker's Memory character data
            byte[] HMCharacterStatsHackerPointsSet = BitConverter.GetBytes((UInt32)numericUpDownHMCharacterStatsHackerPoints.Value);
            saveOpen.Position = (0x4B9BC + hmOffset);
            saveWrite.Write(HMCharacterStatsHackerPointsSet);
            #endregion
            //TODO: Save inventory data in Hacker's Memory character data
            #region HMInventoryData
            #endregion
            #endregion
            saveWrite.Close();
        ...
        void getDigimonPortraitsCS(int slot)
        {
            ...
            var portraitsCS = new PictureBox[] { pictureBoxCSDigimonPartySlot1Portrait, pictureBoxCSDigimonPartySlot2Portrait, pictureBoxCSDigimonPartySlot3Portrait };
            var dotsCS = new PictureBox[] { pictureBoxCSDigimonPartySlot1Dot, pictureBoxCSDigimonPartySlot2Dot, pictureBoxCSDigimonPartySlot3Dot };
            var combosCS = new ComboBox[] { comboBoxCSDigimonPartySlot1ID, comboBoxCSDigimonPartySlot2ID, comboBoxCSDigimonPartySlot3ID };
            short ID = 0;
            try
            {
                ID = convertStringtoDigimonID(combosCS[slot].Text);
            }
            catch
            {
                return;
            }
            portraitsCS[slot].Image = (Image)Properties.Resources.ResourceManager.GetObject($"field{ID:000}");
            dotsCS[slot].Image = (Image)Properties.Resources.ResourceManager.GetObject($"dot{ID:000}");
            portraitsCS[slot].Refresh();
            portraitsCS[slot].Visible = true;
        }
        void getDigimonPortraitsHM(int slot)
        {
            if (--slot < 0 || slot > 2) return;
            var portraitsHM = new PictureBox[] { pictureBoxHMDigimonPartySlot1Portrait, pictureBoxHMDigimonPartySlot2Portrait, pictureBoxHMDigimonPartySlot3Portrait };
            var dotsHM = new PictureBox[] { pictureBoxHMDigimonPartySlot1Dot, pictureBoxHMDigimonPartySlot2Dot, pictureBoxHMDigimonPartySlot3Dot };
            var combosHM = new ComboBox[] { comboBoxHMDigimonPartySlot1ID, comboBoxHMDigimonPartySlot2ID, comboBoxHMDigimonPartySlot3ID };
            short ID = 0;
            try
            {
                ID = convertStringtoDigimonID(combosHM[slot].Text);
            }
            catch
            {
                return;
            }
            portraitsHM[slot].Image = (Image)Properties.Resources.ResourceManager.GetObject($"field{ID:000}");
            dotsHM[slot].Image = (Image)Properties.Resources.ResourceManager.GetObject($"dot{ID:000}");
            portraitsHM[slot].Refresh();
            portraitsHM[slot].Visible = true;
        }
        string convertGenderIDtoString(short genderID)
        {
            string gender;
            switch (genderID)
            {
        ...
        byte convertStringtoGenderID(string gender)
        {
            byte genderID;
            switch (gender)
            {
        ...
        private void pictureBoxHMDigimonPartySlot2Dot_Click(object sender, EventArgs e)
        {
        }
        private void numericUpDownCSCharacterStatsCharacterRank_Validated(object sender, EventArgs e)
        {
            FileStream savegameFs = new FileStream(savegame, FileMode.Open);
            BinaryReader savegameBr = new BinaryReader(savegameFs);
            savegameBr.BaseStream.Position = 0x4B9BC;
            byte[] CSCharacterStatsCSP = savegameBr.ReadBytes(4);
            UInt32 CSCharacterStatsCSPDec = BitConverter.ToUInt32(CSCharacterStatsCSP, 0);
            switch (numericUpDownCSCharacterStatsCharacterRank.Value)
            {
                case 0:
                    if (numericUpDownCSCharacterStatsCSP.Value >= 1000)
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 0;
                    }
                    break;
                case 1:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 1000) || (numericUpDownCSCharacterStatsCSP.Value >= 3000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 1000;
                    }
                    break;
                case 2:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 3000) || (numericUpDownCSCharacterStatsCSP.Value >= 5000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 3000;
                    }
                    break;
                case 3:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 5000) || (numericUpDownCSCharacterStatsCSP.Value >= 7000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 5000;
                    }
                    break;
                case 4:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 7000) || (numericUpDownCSCharacterStatsCSP.Value >= 9000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 7000;
                    }
                    break;
                case 5:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 9000) || (numericUpDownCSCharacterStatsCSP.Value >= 11000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 9000;
                    }
                    break;
                case 6:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 11000) || (numericUpDownCSCharacterStatsCSP.Value >= 13000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 11000;
                    }
                    break;
                case 7:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 13000) || (numericUpDownCSCharacterStatsCSP.Value >= 15000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 13000;
                    }
                    break;
                case 8:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 15000) || (numericUpDownCSCharacterStatsCSP.Value >= 17000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 15000;
                    }
                    break;
                case 9:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 17000) || (numericUpDownCSCharacterStatsCSP.Value >= 20000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 17000;
                    }
                    break;
                case 10:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 20000) || (numericUpDownCSCharacterStatsCSP.Value >= 23000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 20000;
                    }
                    break;
                case 11:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 23000) || (numericUpDownCSCharacterStatsCSP.Value >= 26000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 23000;
                    }
                    break;
                case 12:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 26000) || (numericUpDownCSCharacterStatsCSP.Value >= 29000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 26000;
                    }
                    break;
                case 13:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 29000) || (numericUpDownCSCharacterStatsCSP.Value >= 32000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 29000;
                    }
                    break;
                case 14:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 32000) || (numericUpDownCSCharacterStatsCSP.Value >= 35000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 32000;
                    }
                    break;
                case 15:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 35000) || (numericUpDownCSCharacterStatsCSP.Value >= 38000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 35000;
                    }
                    break;
                case 16:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 38000) || (numericUpDownCSCharacterStatsCSP.Value >= 41000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 38000;
                    }
                    break;
                case 17:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 41000) || (numericUpDownCSCharacterStatsCSP.Value >= 44000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 41000;
                    }
                    break;
                case 18:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 44000) || (numericUpDownCSCharacterStatsCSP.Value >= 47000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 44000;
                    }
                    break;
                case 19:
                    if ((numericUpDownCSCharacterStatsCSP.Value < 47000) || (numericUpDownCSCharacterStatsCSP.Value > 50000))
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 47000;
                    }
                    break;
                case 20:
                    if (numericUpDownCSCharacterStatsCSP.Value < 50000)
                    {
                        numericUpDownCSCharacterStatsCSP.Value = 50000;
                    }
                    break;
                default:
                    numericUpDownCSCharacterStatsCSP.Value = CSCharacterStatsCSPDec;
        ...
        private void numericUpDownHMCharacterStatsCharacterRank_Validated(object sender, EventArgs e)
        {
            FileStream savegameFs = new FileStream(savegame, FileMode.Open);
            BinaryReader savegameBr = new BinaryReader(savegameFs);
            savegameBr.BaseStream.Position = (0x4B9BC + hmOffset);
            byte[] HMCharacterStatsHackerPoints = savegameBr.ReadBytes(4);
            UInt32 HMCharacterStatsHackerPointsDec = BitConverter.ToUInt32(HMCharacterStatsHackerPoints, 0);
            switch (numericUpDownHMCharacterStatsCharacterRank.Value)
            {
                case 0:
                    if (numericUpDownHMCharacterStatsHackerPoints.Value >= 1000)
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 0;
                    }
                    break;
                case 1:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 1000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 3000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 1000;
                    }
                    break;
                case 2:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 3000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 5000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 3000;
                    }
                    break;
                case 3:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 5000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 7000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 5000;
                    }
                    break;
                case 4:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 7000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 9000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 7000;
                    }
                    break;
                case 5:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 9000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 11000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 9000;
                    }
                    break;
                case 6:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 11000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 13000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 11000;
                    }
                    break;
                case 7:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 13000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 15000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 13000;
                    }
                    break;
                case 8:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 15000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 17000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 15000;
                    }
                    break;
                case 9:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 17000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 20000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 17000;
                    }
                    break;
                case 10:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 20000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 23000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 20000;
                    }
                    break;
                case 11:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 23000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 26000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 23000;
                    }
                    break;
                case 12:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 26000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 29000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 26000;
                    }
                    break;
                case 13:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 29000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 32000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 29000;
                    }
                    break;
                case 14:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 32000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 35000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 32000;
                    }
                    break;
                case 15:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 35000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 38000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 35000;
                    }
                    break;
                case 16:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 38000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 41000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 38000;
                    }
                    break;
                case 17:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 41000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 44000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 41000;
                    }
                    break;
                case 18:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 44000) || (numericUpDownHMCharacterStatsHackerPoints.Value >= 47000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 44000;
                    }
                    break;
                case 19:
                    if ((numericUpDownHMCharacterStatsHackerPoints.Value < 47000) || (numericUpDownHMCharacterStatsHackerPoints.Value > 50000))
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 47000;
                    }
                    break;
                case 20:
                    if (numericUpDownHMCharacterStatsHackerPoints.Value < 50000)
                    {
                        numericUpDownHMCharacterStatsHackerPoints.Value = 50000;
                    }
                    break;
                default:
                    numericUpDownHMCharacterStatsHackerPoints.Value = HMCharacterStatsHackerPointsDec;
